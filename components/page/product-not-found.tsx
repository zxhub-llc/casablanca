        ...
        <div className="relative w-full h-screen overflow-hidden bg-background">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full h-full max-w-4xl mx-auto text-center px-4">
                ...
                <div className="space-y-4 max-w-3xl mx-auto flex flex-col items-center">
                    ...
                    <p className="text-base sm:text-lg text-white font-normal max-w-2xl text-balance leading-tight drop-shadow-xs">
                        Aún no contamos con productos disponibles en esta categoría. Te sugerimos regresar a la tienda principal para explorar otras opciones.
                    </p>
                </div>
                <Button
